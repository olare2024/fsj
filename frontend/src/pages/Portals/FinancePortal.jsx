// frontend/src/pages/Portals/FinancePortal.jsx
...
const FinancePortal = () => {
  ...
  const fetchDashboardData = useCallback(async (showRefreshing = false) => {
    try {
      ...
      if (response.success) {
        console.log('📊 Finance Portal API Response:', response.data);
  ...
  const feeCollectionProgress = dashboardData?.fee_collection || dashboardData?.fee_progress || [];
    ...
    return (
      <Container className="mt-4">
        <div className="text-center py-5">
          ...
          <p className="mt-3 text-muted">Loading your finance portal...</p>
        </div>
      </Container>
    );
  }
    ...
    return (
      <Container className="mt-4">
        <Alert variant="danger">
          <Alert.Heading>Unable to Load Finance Portal</Alert.Heading>
          {error}
          <div className="mt-3">
      ...
      <Row className="mb-4">
        <Col>
          <div className="d-flex justify-content-between align-items-center">
            <div>
              <h1 className="h3 mb-1">Finance Portal</h1>
      ...
      <Row>
        ...
        <Col lg={6} className="mb-4">
          <Card className="border-0 shadow-sm h-100">
            <Card.Header className="bg-white border-0 py-3">
              <div className="d-flex justify-content-between align-items-center">
                <h5 className="mb-0">Fee Collection Progress</h5>
                <Button as={Link} to="/finance/reports" variant="outline-primary" size="sm">
                  View Reports
                </Button>
              </div>
            </Card.Header>
            <Card.Body>
              {feeCollectionProgress.length > 0 ? (
                feeCollectionProgress.map((item, index) => {
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-muted mb-0">No fee collection data available</p>
                </div>
              )}
            </Card.Body>
          </Card>
                ...
                <div className="col-12 col-md-4 mb-3">
                  <div className="d-flex align-items-center p-3 bg-light rounded">
                    ...
                    <div>
                      ...
                      <div className="text-muted">{summary.pendingApprovals} payments waiting for approval</div>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-md-4 mb-3">
                  <div className="d-flex align-items-center p-3 bg-light rounded">
                    <i className="fas fa-exclamation-circle text-danger fs-4 me-3"></i>
                    <div>
                      <div className="fw-bold">Overdue Payments</div>
                      <div className="text-muted">{summary.overdueDebts} students with overdue fees</div>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-md-4 mb-3">
                  <div className="d-flex align-items-center p-3 bg-light rounded">
                    <i className="fas fa-balance-scale text-info fs-4 me-3"></i>
                    <div>
                      <div className="fw-bold">Reconciliation</div>
                      <div className="text-muted">23 records need reconciliation</div>
                    </div>
                  </div>
                </div>
              </Row>
